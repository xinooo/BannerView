...
import com.xinooo.banner.databinding.ActivityPortraitBannerBinding
...
import com.xinooo.bannerlib.transformer.CascadingPageTransformer

class PortraitBannerActivity : AppCompatActivity() {

    private lateinit var binding: ActivityPortraitBannerBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        supportActionBar?.title = "PortraitBanner"
        binding = DataBindingUtil.setContentView(this, R.layout.activity_portrait_banner)
        ...
        binding.banner.addBannerLifecycleObserver(this)
            .setPageTransformer(CascadingPageTransformer())
